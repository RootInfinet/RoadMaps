...
function Hero() {
    return (
        <div className='w-full flex flex-col items-center justify-center text-center pt-32 sm:pt-36 md:pt-45 px-4 sm:px-6'>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#E5E2E1] mt-6 sm:mt-8 md:mt-10 max-w-[90vw] sm:max-w-140 md:w-140 leading-tight sm:leading-14">
            ...
            <p className="text-[#BACCB0] mt-4 sm:mt-6 max-w-[90vw] sm:max-w-140 md:w-140 leading-5 sm:leading-6 mb-6 sm:mb-10 text-sm sm:text-base">
