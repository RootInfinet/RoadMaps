    ...
    <div className="bg-[#0A0A0A] min-h-screen text-[#BACCB0] p-10 font-mono">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            Your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your information when you use <strong>RoadMaps</strong>.
          </p>
        ...
        <section>
          ...
          <p className="mb-4">
            By using <strong>RoadMaps</strong>, you agree to these terms.
          </p>
          <ul className="list-disc ml-5 space-y-2">
